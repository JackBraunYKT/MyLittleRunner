...
public class Ground extends GameActor {
    ...
    public Ground(Body body) {
        ...
        textureRegionBounds1 = new Rectangle(0 - getUserData().getWidth()/2f, 0, getUserData().getWidth(), getUserData().getHeight());
        textureRegionBounds2 = new Rectangle(getUserData().getWidth()/2f, 0, getUserData().getWidth(), getUserData().getHeight());
    }
